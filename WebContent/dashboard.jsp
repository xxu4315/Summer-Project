    ...
    <div class="container-fluid">
        ...
        <div style="background-image:url(/static/Uploads/Stevens.jpg)" class="well">
            <div class="row">
                ...
                <div align="center" class="col-sm-4 col-md-4">
                    <div>
                        <img class="img-circle" alt="100%x200" src="static/Uploads/bucketList.jpg" data-holder-rendered="true" style="height: 300px; width: 400px; display: block;">
                        <div class="caption">
                            <h3></h3>
                            <p style="font-size:200%">Community</p>
                            <!--<p>
                                <button type="button" class="btn btn-danger btn-sm">
                                    <span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>
                                </button>
                ...
                <div align="center" class="col-sm-4 col-md-4">
                    <div>
                        ...
                        <div class="caption">
                            <h3></h3>
                            <p style="font-size:200%">Dining</p>
                            <!--<p>
                                <button type="button" class="btn btn-danger btn-sm">
                                    <span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>
                                </button>
