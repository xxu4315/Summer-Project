...
public class PostHouseCL extends HttpServlet {
	...
	private String uploadPath = "/Users/Eric/Documents/Summerproject/webproject/WebContent/static/Uploads/houseinfoimg"; //D:\BitBucket\Test\WebContent\WEB-INF\static\\upload
    private String tempPath = "/Users/Eric/Documents/imgRepo"; // temp file repository
    File tempPathFile;   
    /**
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
		      //String uid;
			           ...
			           upload.setSizeMax(41943040); // 4MB
			            	...
			            	//get name
			            	 ...
			            	 //store it into map
			            	  ...
			            	  if(key.equals("email")){
			            		...
			            		//  ufile.createNewFile();
				                  System.out.println(ufile.mkdir());
			...
			if(email != null && h_location != null && h_area != null){
				boolean check = hbc.posthouse(email, title, h_location, h_area, housetype, roomtype, sex, wechatid, qq, phonenumber, price, houseinfo, uploadPath);
				if(check == false){
